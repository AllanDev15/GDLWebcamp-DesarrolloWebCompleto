          ...
          <div class="card-body">
            ...
            <form role="form" name="guardar-registro-archivo" id="guardar-registro-archivo" method="post"
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nombre_invitado" id="nombre_invitado"
                    placeholder="Nombre" value="<?= $invitado['nombre_invitado'] ?>">
                </div>
                <div class="form-group">
                  <label for="apellido_invitado">Apellido</label>
                  <input type="text" class="form-control" name="apellido_invitado" id="apellido_invitado"
                    placeholder="Apellido" value="<?= $invitado['apellido_invitado'] ?>">
                </div>
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="biografia_invitado" id="biografia_invitado" rows="8"
                    placeholder="Biografia"><?= $invitado['descripcion'] ?></textarea>
                </div>
                <div class="from-group">
                  <label for="imagen_actual">Imagen Actual</label>
                  <br>
                  <img src="../img/invitados/<?= $invitado['url_imagen'] ?>" width="150px">
                </div>
                <div class="form-group">
              ...
              <div class="card-footer">
                ...
                <input type="hidden" name="id_registro" value="<?= $invitado['invitado_id'] ?>">
