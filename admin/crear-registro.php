...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Crear Registro de Asistentes Manual</h1>
        </div>
        <div class="col-sm-6">
    ...
    <div class="col-md-8">
      <section class="content">
        ...
        <div class="card">
          ...
          <div class="card-body">
            Llena el formulario para registrar asistentes manualmente
                      ...
                      <div id="<?= str_replace('á', 'a', $dia) ?>" class="contenido-dia">
                        ...
                        <div class="tipo-evento row">
                          ...
                          <div class="col-md-4">
                            ...
                            <label>
                              <input type="checkbox" name="registro_evento[]" id="<?= $evento['id'] ?>"
                                value="<?= $evento['id'] ?>">
                      ...
                      <div class="extras col-md-6">
                        <div class="orden">
                          ...
                          <input type="number" id="camisa_evento" name="pedido_extra[camisas][cantidad]" min="0"
                            size="3" placeholder="0" class="form-control">
